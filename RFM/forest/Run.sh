...
if [[ "$choice" == "Train" && "$data" == "s" ]]; then
    spark-submit --class com.forest.RandomForest --master spark://$master.cs.colostate.edu:$port target/forest-1.0-SNAPSHOT.jar hdfs://$master.cs.colostate.edu:$hport/CS435-Term-Project/Data_sample/* /CS435-Term-Project/Model /CS435-Term-Project/Output/RFM-training-sample
elif [[ "$choice" == "Train" && "$data" == "r" ]]; then
    spark-submit --class com.forest.RandomForest --master spark://$master.cs.colostate.edu:$port target/forest-1.0-SNAPSHOT.jar hdfs://$master.cs.colostate.edu:$hport/CS435-Term-Project/Data/* /CS435-Term-Project/Model /CS435-Term-Project/Output/RFM-training-full
